...
# 디비명
DATABASE_NAME       = "de_ai_08_loggen_silver_glue_db"
# 테이블명
...
# s3://버킷/gold/daily_report/year=2026/month=08/day=27/
...
with DAG(  
  ...
  tags        = ['aws', 'athena', 'partition']
    ...
    # 4-2. 동일 날짜에 대해서 중복적 실행하는 컨셉이라면 -> 허용(1일 1회인데 허용), 하루에 여러번 수행 컨셉(누적)
